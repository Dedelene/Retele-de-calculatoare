...
while True:
    ...
    if comanda == 'EXIT':
        ...
        if not este_conectat:
            print("EROARE: Trebuie sa fii conectat pentru a publica.")
            continue
        if not argumente:
            print("EROARE LOCALA: Mesajul nu poate fi gol.")
            continue
        print(trimite_comanda(intrare))

    elif comanda == 'DELETE':
        if not este_conectat:
            print("EROARE: Trebuie sa fii conectat pentru a sterge.")
            continue
        ...
        if not este_conectat:
            print("EROARE: Trebuie sa fii conectat pentru a vedea lista.")
            continue
        print(trimite_comanda(intrare))
